...
class Donations(Dataset):
    file = pm.FileSelector(
        # default='tqf/input/tegr1_vote_coefficients_input.csv',
        path='tqf/input/*.csv',
        constant=True,
    )
    grant_names_dataset = pm.FileSelector(
        # default='tqf/input/tegr1_grants.csv',
        path='tqf/input/*grants.csv',
        constant=True,
    )
    dataset = pm.DataFrame(
        default=None,
...
class TEGR1_TEC(TokenDistribution):
    file = pm.FileSelector(
        default='tqf/input/tegr1_tec_holders.csv',
        path='tqf/input/*.csv',
        constant=True,
    )
...
class TEGR1_TEA(TokenDistribution):
    file = pm.FileSelector(
        default='tqf/input/tegr1_tea_holders_dune.csv',
        path='tqf/input/*.csv',
        constant=True,
    )
...
class TEGR2_TEC(TokenDistribution):
    file = pm.FileSelector(
        default='tqf/input/tegr2_tec_holders.csv',
        path='tqf/input/*.csv',
        constant=True,
    )
...
class TEGR2_TEA(TokenDistribution):
    file = pm.FileSelector(
        default='tqf/input/tegr2_tea_holders.csv',
        path='tqf/input/*.csv',
        constant=True,
    )
...
class TEGR3_TEC(TEGR2_TEC):
    file = pm.FileSelector(
        default='tqf/input/tegr3_tec_holders.csv',
        path='tqf/input/*.csv',
        constant=True,
    )
...
class TEGR3_TEA(TEGR2_TEA):
    file = pm.FileSelector(
        default='tqf/input/tegr3_tea_holders.csv',
        path='tqf/input/*.csv',
        constant=True,
    )
