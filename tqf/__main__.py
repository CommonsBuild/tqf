...
def main(round: str, cli: bool):
    if round == 'tegr1':
        if cli:
            ...
            pn.serve(tegr1_app.servable(), port=5006, show=False)
        ...
        if cli:
            ...
            pn.serve(tegr2_app.servable(), port=5006, show=False)
        ...
        if cli:
            ...
            pn.serve(tegr3_app.servable(), port=5006, show=False)
