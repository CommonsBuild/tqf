...
tegr1_boost_factory = BoostFactory(template=tegr1_tec_boost)
tegr1_boost_factory.param['template'].objects = [tegr1_tec_boost, tegr1_tea_boost]
...
tegr1_boost_factory.template = tegr1_tea_boost
tegr1_boost_factory._new_boost()
